	...
	public class TinymoeProgram : TinymoeOperations
	{
		...
		public TinymoeProgram()
		{
			...
			TinymoeObject.SetExtension(
				...
				"$dispatch<>geometry::area_of_$primitive",
				new TinymoeFunction(__args___x2 => geometry__triangle___dispatch__geometry__area_of__primitive_x2(__args___x2[0], __args___x2[1], __args___x2[2]))
				); 
			TinymoeObject.SetExtension(
				typeof(geometry__circle),
				"$dispatch<>geometry::area_of_$primitive",
				new TinymoeFunction(__args___x3 => geometry__circle___dispatch__geometry__area_of__primitive_x3(__args___x3[0], __args___x3[1], __args___x3[2]))
				); 
			TinymoeObject.SetExtension(
				typeof(TinymoeObject),
				"$dispatch<>geometry::area_of_$primitive",
				new TinymoeFunction(__args___x4 => TinymoeObject___dispatch__geometry__area_of__primitive_x4(__args___x4[0], __args___x4[1], __args___x4[2]))
				); 
			TinymoeObject.SetExtension(
				typeof(geometry__rectangle),
				"$dispatch<>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x5 => geometry__rectangle___dispatch__geometry___primitive_and__expression_are_the_same_shape(__args___x5[0], __args___x5[1], __args___x5[2], __args___x5[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(geometry__rectangle),
				"$dispatch<geometry::rectangle>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x6 => geometry__rectangle___dispatch_geometry__rectangle_geometry___primitive_and__expression_are_the_same_shape(__args___x6[0], __args___x6[1], __args___x6[2], __args___x6[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(geometry__triangle),
				"$dispatch<>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x7 => geometry__triangle___dispatch__geometry___primitive_and__expression_are_the_same_shape_x2(__args___x7[0], __args___x7[1], __args___x7[2], __args___x7[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(geometry__triangle),
				"$dispatch<geometry::triangle>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x8 => geometry__triangle___dispatch_geometry__triangle_geometry___primitive_and__expression_are_the_same_shape(__args___x8[0], __args___x8[1], __args___x8[2], __args___x8[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(geometry__circle),
				"$dispatch<>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x9 => geometry__circle___dispatch__geometry___primitive_and__expression_are_the_same_shape_x3(__args___x9[0], __args___x9[1], __args___x9[2], __args___x9[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(geometry__circle),
				"$dispatch<geometry::circle>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x10 => geometry__circle___dispatch_geometry__circle_geometry___primitive_and__expression_are_the_same_shape(__args___x10[0], __args___x10[1], __args___x10[2], __args___x10[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(TinymoeObject),
				"$dispatch<>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x11 => TinymoeObject___dispatch__geometry___primitive_and__expression_are_the_same_shape_x4(__args___x11[0], __args___x11[1], __args___x11[2], __args___x11[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(TinymoeObject),
				"$dispatch<geometry::circle>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x12 => TinymoeObject___dispatch_geometry__circle_geometry___primitive_and__expression_are_the_same_shape_x2(__args___x12[0], __args___x12[1], __args___x12[2], __args___x12[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(TinymoeObject),
				"$dispatch<geometry::rectangle>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x13 => TinymoeObject___dispatch_geometry__rectangle_geometry___primitive_and__expression_are_the_same_shape_x2(__args___x13[0], __args___x13[1], __args___x13[2], __args___x13[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(TinymoeObject),
				"$dispatch<geometry::triangle>geometry::$primitive_and_$expression_are_the_same_shape",
				new TinymoeFunction(__args___x14 => TinymoeObject___dispatch_geometry__triangle_geometry___primitive_and__expression_are_the_same_shape_x2(__args___x14[0], __args___x14[1], __args___x14[2], __args___x14[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(TinymoeArray),
				"$dispatch<>standard_library::repeat_with_$argument_in_$expression",
				new TinymoeFunction(__args___x15 => TinymoeArray___dispatch__standard_library__repeat_with__argument_in__expression(__args___x15[0], __args___x15[1], __args___x15[2], __args___x15[3]))
				); 
			TinymoeObject.SetExtension(
				typeof(TinymoeObject),
				"$dispatch<>standard_library::repeat_with_$argument_in_$expression",
				new TinymoeFunction(__args___x16 => TinymoeObject___dispatch__standard_library__repeat_with__argument_in__expression_x2(__args___x16[0], __args___x16[1], __args___x16[2], __args___x16[3]))
				); 
		}
